        ...
        <div class="col-md-3 ">
            <div class="card ">
                <div class="card-body text-center">
                    <h5 class="fw-semibold fs-5 mb-4">Humadity</h5>
                    <div class="position-relative overflow-hidden d-inline-block">
                        <img src="{{ url('admin/icons/humadity.svg') }}" width="80" alt=""
                            class="img-fluid mb-4 rounded-circle position-relative" width="140">
                    </div>
                    <h1 class="display-6 mb-3 px-xl-5" id="humadity"></h1>
                </div>
            </div>
        </div>
    </div>
