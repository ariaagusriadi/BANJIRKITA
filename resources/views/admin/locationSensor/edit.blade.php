                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-floating mb-3">
                                    <input name="location_name" type="text" value="{{ $locationSensor->location_name }}"
                            ...
                            <div class="col-md-6">
                                <div class="form-floating mb-3">
                                    <input name="sensor_name" type="text" value="{{ $locationSensor->sensor_name }}"
        ...
        <div class="col-md-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <input id="posisi" readonly type="text" value="{{ $locationSensor->location }}" required
