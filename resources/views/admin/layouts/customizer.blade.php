    ...
    <div class="offcanvas-body p-4">
        <div class="theme-option pb-4">
            ...
            <div class="d-flex align-items-center gap-3 my-3">
                <a href="javascript:void(0)" onclick="toggleTheme('{{ url('admin') }}/dist/css/style.min.css')"
                    class="rounded-2 p-9 customizer-box hover-img d-flex align-items-center gap-2 light-theme text-dark">
                    <i class="ti ti-brightness-up fs-7 text-primary"></i>
                    <span class="text-dark">Light</span>
                </a>
                <a href="javascript:void(0)" onclick="toggleTheme('{{ url('admin') }}/dist/css/style-dark.min.css')"
                ...
                <ul class="list-unstyled mb-0 d-flex gap-3 flex-wrap change-colors">
                    <li class="rounded-2 p-9 customizer-box hover-img d-flex align-items-center justify-content-center">
                        <a href="javascript:void(0)"
                            ...
                            onclick="toggleTheme('{{ url('admin') }}/dist/css/style.min.css')" data-color="blue_theme"
                    ...
                    <li class="rounded-2 p-9 customizer-box hover-img d-flex align-items-center justify-content-center">
                        <a href="javascript:void(0)"
                            ...
                            onclick="toggleTheme('{{ url('admin') }}/dist/css/style-aqua.min.css')"
                    ...
                    <li class="rounded-2 p-9 customizer-box hover-img d-flex align-items-center justify-content-center">
                        <a href="javascript:void(0)"
                            ...
                            onclick="toggleTheme('{{ url('admin') }}/dist/css/style-purple.min.css')"
                    ...
                    <li class="rounded-2 p-9 customizer-box hover-img d-flex align-items-center justify-content-center">
                        <a href="javascript:void(0)"
                            ...
                            onclick="toggleTheme('{{ url('admin') }}/dist/css/style-green.min.css')"
                    ...
                    <li class="rounded-2 p-9 customizer-box hover-img d-flex align-items-center justify-content-center">
                        <a href="javascript:void(0)"
                            ...
                            onclick="toggleTheme('{{ url('admin') }}/dist/css/style-cyan.min.css')"
                    ...
                    <li class="rounded-2 p-9 customizer-box hover-img d-flex align-items-center justify-content-center">
                        <a href="javascript:void(0)"
                            ...
                            onclick="toggleTheme('{{ url('admin') }}/dist/css/style-orange.min.css')"
