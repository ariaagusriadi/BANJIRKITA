                        ...
                        <div class="col-4 ms-n4">
                            <div class="position-relative p-7 border-start h-100">
                                ...
                                <ul class="">
                                    ...
                                    <li class="mb-3">
                                        <a class="fw-semibold text-dark bg-hover-primary" href="app-notes.html">Notes
                                            App</a>
                                    </li>
                                    <li class="mb-3">
                                        <a class="fw-semibold text-dark bg-hover-primary"
                        ...
                        <div class="dropdown-menu content-dd dropdown-menu-end dropdown-menu-animate-up"
                            ...
                            <div class="message-body" data-simplebar>
                                ...
                                <a href="javascript:void(0)"
                                    class="py-6 px-7 d-flex align-items-center dropdown-item">
                                    <span class="me-3">
                                        <img src="{{ url('admin') }}/dist/images/profile/user-5.jpg" alt="user"
                                            class="rounded-circle" width="48" height="48" />
                                    </span>
                                    <div class="w-75 d-inline-block v-middle">
                                ...
                                <div class="d-grid py-4 px-7 pt-8">
                                    <div
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                <div class="m-n4">
                                                    <img src="{{ url('admin') }}/dist/images/backgrounds/unlimited-bg.png"
                                                        alt="" class="w-100">
                                                </div>
                                            </div>
                                        </div>
