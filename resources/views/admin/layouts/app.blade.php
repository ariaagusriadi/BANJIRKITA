...
<body>
                                        ...
                                        <tbody class="border-top">
                                            <tr>
                                                <td class="ps-0">
                                                    <div class="d-flex align-items-center">
                                                        <div class="me-2 pe-1">
                                                            <img src="{{ url('admin') }}/dist/images/products/product-1.jpg"
                                            ...
                                            <tr>
                                                <td class="ps-0">
                                                    <div class="d-flex align-items-center">
                                                        <div class="me-2 pe-1">
                                                            <img src="{{ url('admin') }}/dist/images/products/product-2.jpg"
                                                                class="rounded-2" width="48" height="48"
                                                                alt="" />
                                                        </div>
                                                        <div>
                                            ...
                                            <tr>
                                                <td class="ps-0">
                                                    <div class="d-flex align-items-center">
                                                        <div class="me-2 pe-1">
                                                            <img src="{{ url('admin') }}/dist/images/products/product-3.jpg"
                                                                class="rounded-2" width="48" height="48"
                                                                alt="" />
                                                        </div>
                                                        <div>
                                            ...
                                            <tr>
                                                <td class="ps-0 border-bottom-0">
                                                    <div class="d-flex align-items-center">
                                                        <div class="me-2 pe-1">
                                                            <img src="{{ url('admin') }}/dist/images/products/product-4.jpg"
                                                                class="rounded-2" width="48" height="48"
                                                                alt="" />
                                                        </div>
                                                        <div>
    ...
    <script src="{{ url('admin') }}/dist/libs/apexcharts/dist/apexcharts.min.js"></script>
    <script src="{{ url('admin') }}/dist/js/dashboard2.js"></script>
</body>
